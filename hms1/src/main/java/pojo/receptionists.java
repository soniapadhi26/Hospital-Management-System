...
public class receptionists {
	...
	public receptionists(String name, String username,String email,long phone,String fatherName,String city,String address,String dob,int age,String gender,String bloodGroup,String qualification) {
		super();
		this.name=name;
